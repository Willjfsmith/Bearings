const V='bearings-v10';
const SHELL=['./','./index.html','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png',
  './css/app.css?v=10','./js/app.js?v=10',
  './js/data/world.js?v=10','./js/data/states.js?v=10','./js/data/cities.js?v=10','./js/data/features.js?v=10',
  './js/data/landmarks.js?v=10','./js/data/maps.js?v=10','./js/data/capitals.js?v=10','./js/data/lib.js?v=10','./js/data/sets.js?v=10'];
